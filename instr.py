...
txt_hintname = "Ф.И.O."
txt_hintage = "0"
txt_test1 = 'Лягте на спину и замерьте пульс за 15 секунд. Нажмите кнопку "Начать первый тест", чтобы запустить таймер. \пРезультат запишите в соответствующее поле.'
...
txt_test3 = """Лягте на спину и замерьте пульс сначала за первые 15 секунд минуты, затем за последние 15 секунд. \Нажмите кнопку
